  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', padding: '24px 16px' }}>
      ...
      {loading ? <p style={{ textAlign: 'center', padding: 24 }}><span className="spinner" /> 加载中...</p>
       : submissions.length === 0 ? <p style={{ textAlign: 'center', padding: 24, color: 'var(--gray-500)' }}>暂无提交</p>
       : (
              ...
              <>
                ...
                {preview.form && (
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <div className="form-group">
                      <label className="form-label">报销表批注</label>
                      <textarea className="form-input" rows={2} value={formComment} onChange={e => setFormComment(e.target.value)} placeholder="报销表问题描述..." />
                    </div>
                  </div>
                )}
